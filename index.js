...
}).type('Designer', {delay: 400}).pause(500).delete(9).type("Developer", {delay: 400}).pause(500).delete(9).go()
...
gsap.from('.nav-item', {opacity: 0, duration: 1, delay: 3, x: -30, stagger: 0.2})
gsap.from('.icons span', {opacity: 0, duration: 1, delay: 3, x: -30, stagger: 0.2})
